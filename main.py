...
def position_out(number, in_frame):
    ...
    for j in range(1, lines):
        out_frame = cv2.line(out_frame, (int(w / lines * j), 0), (int(w / lines * j), h), (128, 128, 128), 2)

    out_frame = cv2.line(out_frame, (0, int(h / 2)), (w, int(h / 2)), (128, 128, 128), 2)
    out_frame = cv2.line(out_frame, (1, 1), (1, w), (128, 128, 128), 2)
    out_frame = cv2.line(out_frame, (h, h), (1, w), (250, 128, 128), 2)
    out_frame = cv2.line(out_frame, (1, h), (1, 1), (250, 128, 128), 2)
    out_frame = cv2.line(out_frame, (1, h), (w, w), (250, 128, 128), 2)
    return out_frame
